    ...
    <AppWrapper>
      <Layout>
        <Content>
            ...
            {carouselImages.map((image, index) => 
              <div className="relative text-center">
                ...
                <div className="absolute bottom-[11%] left-1/2 transform -translate-x-1/2 text-white bg-black bg-opacity-50 p-2.5 rounded-md text-lg">
                  <article>
                    <h3>You are on right place because we make your life easier. Join us.</h3>
                    <p>Looking for someone to complete an obligation in your home?</p>
                    <footer className="text-center mt-4">
                      <Button type="primary" size="large" href="/services" className="bg-darkgoldenrod">Explore services</Button>
                    </footer>
                  </article>
                </div>
              </div>
          ...
          <Title level={2} className="mb-[3%]">You want to join us like employee?</Title>
